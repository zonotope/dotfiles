...
SPACESHIP_RUST_PREFIX="%F{white} [%F{}"
SPACESHIP_RUST_SUFFIX="%F{white}]%F{}"

SPACESHIP_RUBY_PREFIX="%F{white} [%F{}"
SPACESHIP_RUBY_SUFFIX="%F{white}]%F{}"

SPACESHIP_NODE_PREFIX="%F{white} [%F{}"
SPACESHIP_NODE_SUFFIX="%F{white}]%F{}"

SPACESHIP_AWS_PREFIX="%F{white} [%F{}"
SPACESHIP_AWS_SUFFIX="%F{white}]%F{}"

SPACESHIP_PACKAGE_PREFIX="%F{white} [%F{}"
SPACESHIP_PACKAGE_SUFFIX="%F{white}]%F{}"
